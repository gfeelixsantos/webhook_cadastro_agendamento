...
function setProviderCode(exame, agendamento) {
    ...
    {
        let horaAgendamento = agendamento.horario.split(':')
        horaAgendamento = Number(horaAgendamento[0])

        const prestadorLaboratorio = horaAgendamento > 12 ? 61 : 32
        return prestadorLaboratorio
    }
